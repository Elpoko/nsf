...
var _useConditionalFocus = require("./use-conditional-focus");

Object.keys(_useConditionalFocus).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _useConditionalFocus[key]) return;
  exports[key] = _useConditionalFocus[key];
});

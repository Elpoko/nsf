...
export declare function forwardRef<P, T extends As>(component: (props: React.PropsWithChildren<P> & Omit<PropsOf<T>, keyof P | "color" | "ref">, ref: React.Ref<any>) => React.ReactElement | null): ComponentWithAs<T, P>;
export {};

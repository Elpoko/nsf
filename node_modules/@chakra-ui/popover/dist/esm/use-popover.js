...
import { useBoolean, useConditionalFocus, useDisclosure, useFocusOnHide, useIds, useOutsideClick } from "@chakra-ui/hooks";
...
export function usePopover(props) {
  ...
  useOutsideClick({
    ...
    handler: event => {
      ...
      if (trigger === TRIGGER.click && closeOnBlur && !((_triggerRef$current = triggerRef.current) == null ? void 0 : _triggerRef$current.contains(event.target))) {
        onClose();
      }
    }
  });
